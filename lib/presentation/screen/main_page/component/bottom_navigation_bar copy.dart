            ...
            return BottomNavigationBar(
              ...
              items: <BottomNavigationBarItem>[
                BottomNavigationBarItem(
                  tooltip: 'Home',
                  icon: _navIcon(KImages.homeInActive, bottomDeActiveColor),
                  activeIcon: _navIcon(KImages.homeActive, primaryColor),
                  label: "Home",
                ),
                BottomNavigationBarItem(
                  tooltip: " My Menu",
                  icon: _navIcon(KImages.myMenu, bottomDeActiveColor),
                  activeIcon: _navIcon(KImages.myMenuActive, primaryColor),
                  label: 'My Menu',
                ),
                BottomNavigationBarItem(
                  tooltip: 'My Order',
                  icon: _navIcon(KImages.orderInActive, bottomDeActiveColor),
                  activeIcon: _navIcon(KImages.orderActive, primaryColor),
                  label: 'My Order',
                ),
                BottomNavigationBarItem(
                  tooltip: 'Menu',
                  icon: _navIcon(KImages.menu, bottomDeActiveColor),
                  activeIcon: _navIcon(KImages.menuAactive, primaryColor),
                  label: 'Menu',
                ),
              ],
              // type: BottomNavigationBarType.fixed,
