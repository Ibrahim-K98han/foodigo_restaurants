...
const Color textInputFillColor = Color(0xFFF8FAFC);
const Color headingTextColor = Color(0xFF0C1321);
const Color grayTextColor = Color(0xFF6C727F);
const Color timeTextColor = Color(0xFF475569);
const Color smallContainerColor = Color(0xFFF98C3B);
const Color readColor = Color(0xFFE94222);
const Color bottomDeActiveColor = Color(0xFF334155);
const Color lightGreenColor = Color(0xFF00CF7E);
const Color lightReadColor = Color(0xFFFEF1F1);
const Color setAmountBgColor = Color(0xFFF1F5F9);
